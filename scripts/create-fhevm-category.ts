...
const CATEGORIES: Record<string, CategoryConfig> = {
  basic: {
    ...
    contracts: [
      ...
      { path: 'contracts/basic/EncryptSingleValue.sol', test: 'test/basic/EncryptSingleValue.ts' },
      { path: 'contracts/basic/EncryptMultipleValues.sol', test: 'test/basic/EncryptMultipleValues.ts' },
      { path: 'contracts/basic/FHEAdd.sol', test: 'test/basic/FHEAdd.ts' },
      { path: 'contracts/basic/FHEComparison.sol', test: 'test/basic/FHEComparison.ts' },
      { path: 'contracts/basic/FHEIfThenElse.sol', test: 'test/basic/FHEIfThenElse.ts' },
    ],
  },
  decryption: {
    name: 'Decryption Examples',
    description: 'Examples showing different decryption methods (user vs public)',
    contracts: [
      { path: 'contracts/decryption/UserDecryptSingle.sol', test: 'test/decryption/UserDecryptSingle.ts' },
      { path: 'contracts/decryption/UserDecryptMultiple.sol', test: 'test/decryption/UserDecryptMultiple.ts' },
      { path: 'contracts/decryption/PublicDecryptSingle.sol', test: 'test/decryption/PublicDecryptSingle.ts' },
    ],
  },
  'access-control': {
    name: 'Access Control',
    description: 'Patterns for managing access to encrypted data',
    contracts: [
      { path: 'contracts/access-control/AccessControlBasics.sol', test: 'test/access-control/AccessControlBasics.ts' },
      { path: 'contracts/access-control/AccessControlTransient.sol', test: 'test/access-control/AccessControlTransient.ts' },
      { path: 'contracts/access-control/PermissionPatterns.sol', test: 'test/access-control/PermissionPatterns.ts' },
    ],
  },
  antipatterns: {
    name: 'Anti-Patterns (What NOT to do)',
    description: 'Common mistakes and security risks in FHE development',
    contracts: [
      { path: 'contracts/antipatterns/HandleReuseErrors.sol', test: 'test/antipatterns/HandleReuseErrors.ts' },
      { path: 'contracts/antipatterns/MissingPermissions.sol', test: 'test/antipatterns/MissingPermissions.ts' },
      { path: 'contracts/antipatterns/SignerMismatch.sol', test: 'test/antipatterns/SignerMismatch.ts' },
      { path: 'contracts/antipatterns/ViewFunctionAntipattern.sol', test: 'test/antipatterns/ViewFunctionAntipattern.ts' },
    ],
  },
  advanced: {
    name: 'Advanced Examples',
    description: 'Complete dApps and advanced patterns',
    contracts: [
      {
        path: 'contracts/advanced/BlindAuction.sol',
        test: 'test/advanced/BlindAuction.ts',
        fixture: 'test/advanced/BlindAuction.fixture.ts',
      },
      { path: 'contracts/advanced/ConfidentialVoting.sol', test: 'test/advanced/ConfidentialVoting.ts' },
      { path: 'contracts/advanced/PrivateTokenSwap.sol', test: 'test/advanced/PrivateTokenSwap.ts' },
    ],
  },
};
